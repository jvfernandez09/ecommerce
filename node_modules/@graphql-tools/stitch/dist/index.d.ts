import { FieldNode, SelectionSetNode, GraphQLNamedType, GraphQLSchema, GraphQLFieldConfig, GraphQLObjectType, GraphQLInterfaceType, GraphQLInputFieldConfig, GraphQLInputObjectType, GraphQLEnumValueConfig, GraphQLEnumType, GraphQLOutputType, SelectionNode } from 'graphql';
...
declare function calculateSelectionScore(selections: readonly SelectionNode[]): number;
